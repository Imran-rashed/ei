                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="requisitionSummary-range" class="form-control" v-model="date_range" on-change="dateRangeFilter"/> 
...
const app = new Vue({
    ...
    methods:{
        get_data: function(){
            let ref = this;
            axios.post('/requisition/summery/data', {'pagination': ref.pagination, 'requisition_type':ref.requisition_type}).then(function(response){
