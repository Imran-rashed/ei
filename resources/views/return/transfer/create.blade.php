...
@section('title', 'Dashboard - Transfer Return')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                          @if(session('success'))
                                            ...
                                            @endif
                                <form method="post" action="{{ route('transfer_return.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <input id="datetimepicker" type="text" class="form-control" name="date" required value="{{ date('Y/m/d h:m:s') }}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                        ...
                                                        <table id="adjustment-addition" class="table table-striped table-bordered" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="(item,index) in selected_items">
                                                                    ...
                                                                    <td><input type="hidden" v-bind:name="getInputName(index, 'id')" v-model="selected_items[index].id">
                                                                    ...
                                                                    <td>@{{ item.prices.final_cost * selected_items[index].quantity }}</td>
                                    ...
                                    <div>
                                        <button type="sumbit" class="btn btn-primary btn-draft mt-3">draft</button>
